...
@Component({
  ...
  template: `
    <div class="bg-white cursor-pointer runded-xl shadow-lg overflow-hidden flex flex-col ">
            ...
            <div class="p-5 flex flex-col  flex-1">
              ...
              <div class="flex items-center justify-between mt-auto">
                ...
                <button matButton="filled" class="flex items-center gap-2" (click)="addToCard.emit(product())">
